...
Upstream commit: https://github.com/sdkwork-ai/sdkwork-superpowers/commit/$UPSTREAM_SHA
...
Upstream: https://github.com/sdkwork-ai/sdkwork-superpowers/commit/$UPSTREAM_SHA
Branch:   $SYNC_BRANCH"
